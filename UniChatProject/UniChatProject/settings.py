"""
Django settings for UniChatProject project.
...
SECRET_KEY = '44$dy1uexo6*w!)77@owu-9#oa8z7gkco80u35+7pf+s1r$2a@'
...
TEMPLATES = [
    {
        ...
        'DIRS': [str(BASE_DIR.joinpath('UniChatApp/templates'))],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'UniChatProject.wsgi.application'
